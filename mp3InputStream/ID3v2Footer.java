...
public class ID3v2Footer {
   ...
   */
  public ID3v2Footer(MP3InputStream mp3, int location)
	...
	try {
	  footerExists = checkFooter(mp3, location);

	  if (footerExists) {
		readFooter(mp3, location);
	  }
   ...
   *@exception IOException            if an error occurs
   */
  private boolean checkFooter(MP3InputStream raf, int location)
	 throws FileNotFoundException, IOException {
   ...
   *@exception IOException            if an error occurs
   */
  private void readFooter(MP3InputStream raf, int location)
	 throws FileNotFoundException, IOException {
